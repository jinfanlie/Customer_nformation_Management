              ...
              <p>
                ...
                <p>
                  ...
                  <label>
                    ...
                    <input type='radio' value='本科' onChange={(e) => setDaikuan({...daikuan,jiaoyuchengdu:e.target.value})} />
                      本科<div style={{marginLeft:'20px'}}/>
                    <input type='radio' value='专科' onChange={(e) => setDaikuan({...daikuan,jiaoyuchengdu:e.target.value})} />
                      专科<div style={{marginLeft:'20px'}}/>
                    <input type='radio' value='硕士及以上' onChange={(e) => setDaikuan({...daikuan,jiaoyuchengdu:e.target.value})} />
                  ...
                  <label>
                    住宅类型：
                    <input type='radio' value='自购' onChange={(e) => setDaikuan({...daikuan,zhuzhaileixing:e.target.value})}
                    />自购
                    <input type='radio' value='亲属' onChange={(e) => setDaikuan({...daikuan,zhuzhaileixing:e.target.value})}
                    />亲属
                    <input type='radio' value='单位宿舍' onChange={(e) => setDaikuan({...daikuan,zhuzhaileixing:e.target.value})}
                    />单位宿舍
                    <input type='radio' value='租房' onChange={(e) => setDaikuan({...daikuan,zhuzhaileixing:e.target.value})}
                    />租房（租金¥
                    ...
                    />元）
                    <input type='radio' value='按揭' onChange={(e) => setDaikuan({...daikuan,zhuzhaileixing:e.target.value})}
                    />按揭（月供¥
                  ...
                  <label>
                    车辆品牌：
                      ...
                      /><div style={{marginLeft:'20px'}}/>
                      <input type='radio' value='国产' onChange={(e) => setDaikuan({...daikuan,cheliangleixing:e.target.value})}
                      />国产
                      <input type='radio' value='进口' onChange={(e) => setDaikuan({...daikuan,cheliangleixing:e.target.value})}
                      />进口
                  ...
                  <label>
                    ...
                    购车方式：
                    <input type='radio' value='全款' onChange={(e) => setDaikuan({...daikuan,gouchefangshi:e.target.value})}
                      />全款
                    <input type='radio' value='二手' onChange={(e) => setDaikuan({...daikuan,gouchefangshi:e.target.value})}
                      />二手
                    <input type='radio' value='按揭' onChange={(e) => setDaikuan({...daikuan,gouchefangshi:e.target.value})}
